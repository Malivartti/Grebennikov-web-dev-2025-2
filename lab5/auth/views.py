...
from lab5.user.models import User as UserModel
from lab5.user.validate import validate_password
...
class User(UserMixin):
    def __init__(self, user: UserModel):
        ...
        self.is_admin = user.role.name == "Администратор" if user.role else None
